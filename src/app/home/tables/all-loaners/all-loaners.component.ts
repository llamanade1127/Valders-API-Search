...
import {ApiService, Loaner, Ticket} from "../../../api.service";
import {MatPaginator} from "@angular/material/paginator";
import {MatSort, Sort} from "@angular/material/sort";

@Component({
  selector: 'app-all-loaners',
  templateUrl: './all-loaners.component.html',
  styleUrls: ['./all-loaners.component.scss']
})
export class AllLoanersComponent implements AfterViewInit {
  ...
  updateTickets() {
    ...
    this.api.GetAllTickets().subscribe( {
      next: (d) => {
        this.dataSource.data = d.tickets;
        this.loading = false;
        this.loop();
      },
      error: err => {
